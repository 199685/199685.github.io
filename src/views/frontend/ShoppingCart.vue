                ...
                <div class="col-md-10 mb-5 container-75">
                    ...
                    <div class="card pb-1">
                        <div class="card-header d-sm-flex justify-content-between py-1" id="headingOne">
                            ...
                            <p class="d-inline-block h7 mb-0 pr-3">應付金額</p>{{total[0] | currency}}</h2>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tr v-for="product in carts.carts">
                                        <td width="100" class="text-center">
                                            <i class="far fa-trash-alt pointer p-3" @click="removeProduct(product.id)"></i>
                                        </td>
                                        ...
                                        <td>
                                           <div class="d-flex">
                                                <button class="count" @click="quantity('minus', product)">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                                <input type="number" class="qtyInput__1dbgq " min="1" max="200" name="quantity"
                                                    v-model="product.qty" @change="inputQuanproduct(product)">
                                                <button class="count" @click="quantity('plus', product)">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">{{total[0] | currency}}</th>
                                    </tr>
                                </table>
                            </div>
