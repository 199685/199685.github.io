                ...
                <div class="col-md-10 container-75">
                    ...
                    <div class="card pb-1">
                        <div class="card-header d-sm-flex justify-content-between py-1" id="headingOne">
                            ...
                            <h2 class="mb-0 pl-3 pl-sm-0 d-flex align-items-center">
                                <p class="d-inline-block h7 mb-0 pr-3">應付金額</p>$520
                            </h2>
                        </div>
                    ...
                    <div class="p-4 table-border mt-3 shopping-table">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <th>Email</th>
                                    <td>dhhds666aa@gmail.com</td>
                                </tr>
                                <tr>
                                    <th>地址</th>
                                    <td>心北市永和去美有路123號5樓</td>
                                </tr>
                                <tr>
                                    <th>付款狀態</th>
                                    <!-- <th class="text-danger">完成付款</th> -->
                    ...
                    <div class="text-right my-2">
                        <button class="btn new-btn new-btn-order2" type="submit">確認付款</button>
                        <!-- <button class="btn new-btn new-btn-index" type="submit">回首頁</button>
                        <button class="btn new-btn new-btn-buy" type="submit">繼續購買</button> -->
                    </div>
                </div>
